...
async fn main() -> anyhow::Result<()> {
    ...
    println!("Response: {}", resp1.output_text().unwrap_or("<no text>".into()));
    ...
    println!("JSON Response: {}", resp2.output_text().unwrap_or("<no json>".into()));
    ...
    println!("Mathematical Response: {}", resp3.output_text().unwrap_or("<no text>".into()));
    ...
    println!("Response with metadata: {}", resp4.output_text().unwrap_or("<no text>".into()));
